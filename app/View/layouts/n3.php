<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <div>
        <form action=""method="get">
                    ...
                    <input type="text"name="tukhoa"placeholder="Nhập sách cần tìm kiếm"style="border-radius:20px ;border: 2px solid red">
                    <input type="submit"value="search"style="border-radius: 20px;border: 1px solid green">
        </form>
    </div>
...
<!--                <button class="btn btn-primary" type="button"value="Tìm kiếm">-->
